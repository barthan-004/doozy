...
void ROBOTHardwareInterface::init() {
    ...
    num_joints_=6;
	joint_names_[0]="neckro_joint";	
	joint_names_[1]="neckud_joint";
	joint_names_[2]="necktilt_joint";
	joint_names_[3]="l_hand_joint";
      - r_elbow_joint
      - r_wrist_joint
      - r_finger_joint
      - upperbody_joint
	joint_names_[4]="l_shoulder_joint";
	joint_names_[5]="l_elbow_joint";
	joint_names_[5]="l_wrist_joint";	
	joint_names_[5]="l_finger_joint";
	joint_names_[5]="r_hand_joint";
        joint_names_[5]="r_shoulder_joint";
	joint_names_[5]="r_elbow_joint";
	joint_names_[5]="l_arm_joint";
	joint_names_[5]="l_arm_joint";
