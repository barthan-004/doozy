...
def init_can():
    ...
    global VCI_USBCAN2
    global STATUS_OK
    can_dll_name = '/home/doozy/catkin_ws/src/doozy_controller/src/controlcan/libcontrolcan.so'
    canDLL = cdll.LoadLibrary('/home/doozy/catkin_ws/src/doozy_controller/src/controlcan/libcontrolcan.so')
...
if __name__ == "__main__":
	...
	while(1):
		...
		cmd=convert_angle_to_position(a)
		send_can_command(2,30,cmd)
